...
const mapCurrentEvents = () => {
  return currentEvents.news.map((template) => {
...
// {author: 'this.author', categories: 'this.categories', summary: 'this.summary', img_url: 'this.img_url', date: 'this.date', title: 'this.title'};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
...
const returnNames = (arr) => {
  let newArr = arr.reduce((accumulator, character) => {
...
const reversedString = (str) => {
  let answer = str.split('').reduce((accumulator, characters) => {
    return characters + accumulator;
  });
  return answer;
};
